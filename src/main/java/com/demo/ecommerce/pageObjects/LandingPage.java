...
public class LandingPage {
    ...
    @FindBy(xpath = "//div[@class='header-links']/ul/li/a[@class='ico-register']")
    ...
    // Methods to interact with header elements
    ...
    public void clickLoginLink() {
        try {
            webDriverWaits.waitForVisibilityOfElement(loginLink);
            webDriverWaits.waitForElementToBeClickable(loginLink);
            loginLink.click();
        } catch (Exception e) {
//            logger.error(e.getMessage());
            assertFalse(true,"Failed to click on Log in Button");
        }
    }
